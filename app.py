...
st.markdown("""
    ...
    /* 3. [고도화] 통합 작전판 및 내부 카드 스타일 */
    .master-briefing-board {
...
try:
    ...
    with tab_report:
        ...
        # [고도화] 모든 요소를 감싸는 통합 작전판 (HTML Flexbox 레이아웃)
        st.markdown(f"""
        <div class="master-briefing-board">
            ...
            <div class="briefing-strategy-card" style="border-left: 6px solid #f59e0b; margin-top:10px;">
