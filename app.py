...
# [요청 기능] 기본 접속 시 데모 버전으로 연결
user_id = query_params.get("id", "demo") 

# --- [요청 기능] 구글 시트 유입 로깅 로직 (비동기 처리) ---
...
# --- [요청 기능] 마스킹 로직 고도화 (이름 매칭 및 고정형 번호 부여) ---
...
def load_server_data():
    ...
    # [요청 기능] 속도 향상을 위해 파이썬 자체 로직으로 엑셀 읽기
    df_list = []
